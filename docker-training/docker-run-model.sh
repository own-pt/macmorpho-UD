...
./train_model.sh "$DOCKER_COMMAND" $DIR/$CONTAINER_NAME-model $DIR/macmorpho-v1-dev-$DATASET_NAME.conllu $DIR/macmorpho-v1-train-$DATASET_NAME.conllu $ITERATIONS;
...
./report_accuracy.sh "$DOCKER_COMMAND" $DIR/$CONTAINER_NAME-model $DIR/macmorpho-v1-test-$DATASET_NAME.conllu > $DIR/$CONTAINER_NAME-accuracy-report.log ;
