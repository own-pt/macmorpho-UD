...
(-> "uma_ART inimiga_ADJ acirrada_PCP" "uma_ART inimiga_N acirrada_PCP" :dd :cr)
...
(-> "encontrar_V a_ART \(\_\( o_ART \)\_\) parceira_N \(\_\( o_N \)\_\) sonhada_V \(\_\( o_PCP \)\_\) em_PREP" "encontrar_V a_ART \(\_\( o_ART \)\_\) parceira_N \(\_\( o_ART \)\_\) sonhada_PCP \(\_\( o_ART \)\_\) em_PREP" :cr :dd)
...
(-> "foram_V presos_N e_KC interrogados_PCP" "foram_V presos_PCP e_KC interrogados_PCP" :mm :cr)
(-> "Obrigado_PCP \!\_\!" "Obrigado_IN \!\_\!" :cr)
(-> "que_KS os_PROSUB importados_PCP" "que_KS os_PROSUB importados_N" :cr)
